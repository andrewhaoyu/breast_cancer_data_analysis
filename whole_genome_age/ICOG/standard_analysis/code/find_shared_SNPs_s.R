#goal: find shared snps for standard analysis and subtypes analysis with complete data
setwd("/spin1/users/zhangh24/breast_cancer_data_analysis/")
load("./whole_genome_age/ICOG/standard_analysis/result/icog_result_standard_s.Rdata")
load("./whole_genome_age/ONCO/standard_analysis/result/onco_result_standard_s.Rdata")
...
save(icog_result_shared_1p,file="./whole_genome_age/ICOG/standard_analysis/result/icog_result_shared_1p_s.Rdata")
save(onco_result_shared_1p,file="./whole_genome_age/ONCO/standard_analysis/result/onco_result_shared_1p_s.Rdata")
...
save(icog_result_only_shared_1p,file="./whole_genome_age/ONCO/standard_analysis/result/icog_result_only_shared_1p_s.Rdata")
save(onco_result_only_shared_1p,file="./whole_genome_age/ONCO/standard_analysis/result/onco_result_only_shared_1p_s.Rdata")
