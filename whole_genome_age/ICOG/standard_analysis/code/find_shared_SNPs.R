...
load("./whole_genome_age/ICOG/standard_analysis/result/icog_result_standard.Rdata")
load("./whole_genome_age/ONCO/standard_analysis/result/onco_result_standard.Rdata")
...
save(icog_result_shared_1p,file="./whole_genome_age/ICOG/standard_analysis/result/icog_result_shared_1p.Rdata")
save(onco_result_shared_1p,file="./whole_genome_age/ONCO/standard_analysis/result/onco_result_shared_1p.Rdata")
...
save(icog_result_only_shared_1p,file="./whole_genome_age/ONCO/standard_analysis/result/icog_result_only_shared_1p.Rdata")
save(onco_result_only_shared_1p,file="./whole_genome_age/ONCO/standard_analysis/result/onco_result_only_shared_1p.Rdata")
