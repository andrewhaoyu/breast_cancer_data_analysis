...
for(i in 1:length(Files)){
  print(i)
  for(k in 1:30){
    load(paste0("/data/zhangh24/breast_cancer_data_analysis/whole_genome_age/ICOG/ERPRHER2GRADE_casecase/result/ERPRHER2Grade_casecase_sex",idx[i],"_",k))
    temp <- nrow(result[[2]])
...
save(icog_result_casecase,file="/data/zhangh24/breast_cancer_data_analysis/whole_genome_age/ICOG/ERPRHER2GRADE_casecase/result/Icog_result_casecase_sex.Rdata")
