...
if(i1==1){
  ...
  qq(gwas_result$P,main=paste0(" Global Test Association Manhattan QQ Plot"),xlim=c(0,8),ylim=c(0,20))
  dev.off()
 ...
 # load("/spin1/users/zhangh24/breast_cancer_data_analysis/whole_genome_age/ICOG/ERPRHER2GRADE_fixed_baseline/result/extract.list.ld")
  ...
  qq(gwas_result$P,main=paste0(" Global Test Association Manhattan QQ Plot"),ylim=c(0,15),xlim=c(1,8))
  dev.off()
