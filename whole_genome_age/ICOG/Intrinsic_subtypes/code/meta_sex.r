...
meta_result_shared_1p_final = rbind(
  meta_result_shared_1p[,c(1:8,11:45)],
  meta_result_shared_1p_sex[,c(1:3,6:45)] )
meta_result_shared_1p <- meta_result_shared_1p_final
save(meta_result_shared_1p,file = "/spin1/users/zhangh24/breast_cancer_data_analysis/whole_genome_age/ICOG/Intrinsic_subtypes/result/meta_result_shared_1p_final.Rdata")
