...
result <- list(p_mglobal_result,p_topo)

#change the output directory to your own directory
save(result,file=paste0("./result_six2/simu_result_0.25_",i1,".Rdata"))
