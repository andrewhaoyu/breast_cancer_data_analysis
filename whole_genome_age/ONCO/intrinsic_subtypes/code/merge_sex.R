...
for(i in 1:32){
  print(i)
    ...
    for(k in 1:30){
      load(
        paste0("./whole_genome_age/ONCO/intrinsic_subtypes/result/intrinsic_subytpe_onco_sex_",idx[i],"_",k))
      temp <- nrow(result[[2]])
...
save(onco_result_casecase,file="/spin1/users/zhangh24/breast_cancer_data_analysis/whole_genome_age/ONCO/intrinsic_subtypes/result/onco_result_intrinsic_subtype_sex.Rdata")
print(1)
