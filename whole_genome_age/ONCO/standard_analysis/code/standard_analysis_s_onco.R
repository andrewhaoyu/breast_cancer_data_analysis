#goal: #analyze the heritability only on invasive cases and five intrinsic subtypes with complete data
rm(list=ls())
...
save(result,file=paste0("./whole_genome_age/ONCO/standard_analysis/result/standard_analysis_onco_s_",i1,"_",i2))
