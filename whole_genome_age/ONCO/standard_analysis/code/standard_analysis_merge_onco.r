...
for(i in 1:567){
    ...
    for (k in 1:3) {
      ...
      load(
        paste0("./whole_genome_age/ONCO/standard_analysis/result/standard_analysis_onco_",idx[i],"_",k)
      )
      temp <- nrow(result[[2]])
...
save(onco_result_casecase,file="./whole_genome_age/ONCO/standard_analysis/result/onco_result_standard.Rdata")
print(1)
