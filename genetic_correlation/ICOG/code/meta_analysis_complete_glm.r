...
##########chang the name to recognizeable name
meta.result.completeglm <- meta.result
load(paste0("./genetic_correlation/ICOG/result/meta.result.completeglm.Rdata"))
save(meta.result.completeglm,file=paste0("./genetic_correlation/ICOG/result/meta.result.completeglm.Rdata"))
...
colnames(ICOG.result.clean) <- c( "SNP.ICOG",
                                  "chr.pos",
                                  "SNP",
                                  "A1",
                                  "A2",
                                  ...
                                  c(1:25),
                                  "freq.icog")
colnames(ONCO.result.clean)[11:40] <- c( "Luminal_A",
                                         "Luminal_B",
                                         "Luminal_B_HER2Enriched",
                                         "HER2Enriched",
                                         "TripleNeg",
...
ICOG.result.completeglm <- ICOG.result.clean
save(ICOG.result.completeglm, file = "./genetic_correlation/result/ICOG.result.clean.completeglm.Rdata")
head(ICOG.result.completeglm)
#load("./genetic_correlation/result/onco.result.clean.completeglm.Rdata")
ONCO.result.completeglm <- ONCO.result.clean
save(ONCO.result.completeglm, file = "./genetic_correlation/result/onco.result.clean.completeglm.Rdata")
