...
N.lua <- 1/(CIMBA.BCAC.meta.result[,27]*2*CIMBA.BCAC.meta.result[,11]*(1-CIMBA.BCAC.meta.result[,11]))
median(N.lua)
N.TN <- 1/(CIMBA.BCAC.meta.result[,51]*2*CIMBA.BCAC.meta.result[,11]*(1-CIMBA.BCAC.meta.result[,11]))
median(N.TN)
