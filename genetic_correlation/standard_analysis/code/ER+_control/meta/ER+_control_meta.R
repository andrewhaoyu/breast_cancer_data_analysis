...
ERPos_control_meta_result = data.frame(rs_id,CHR,position,logodds_meta,sd_meta,stringsAsFactors=F)

save(ERPos_control_meta_result,file=paste0("/data/zhangh20/breast_cancer/standard_gwas/ER+_control/meta/ER+_control_meta_result",i1,".Rdata"))
