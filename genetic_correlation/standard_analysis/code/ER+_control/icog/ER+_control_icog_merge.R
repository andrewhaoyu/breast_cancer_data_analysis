...
setwd("/data/zhangh20/breast_cancer/standard_gwas/ER+_control/icog/")
for(i in 1:length(Files)){
print(i)
...
save(icog_result,file=paste0("/data/zhangh20/breast_cancer/standard_gwas/ER+_control/icog/icog_result_odds_sd.Rdata"))
