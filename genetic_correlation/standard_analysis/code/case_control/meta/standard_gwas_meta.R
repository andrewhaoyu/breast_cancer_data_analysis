...
case_control_meta_result = data.frame(rs_id,CHR,position,logodds_meta,sd_meta,stringsAsFactors=F)

save(case_control_meta_result,file=paste0("/data/zhangh20/breast_cancer/standard_gwas/case_control/meta/case_control_meta_result",i1,".Rdata"))
