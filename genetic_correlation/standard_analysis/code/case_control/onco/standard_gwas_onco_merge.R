...
setwd("/data/zhangh20/breast_cancer/standard_gwas/case_control/onco/")
for(i in 1:length(Files)){
print(i)
  ...
  load(paste0("result",idx[i]))
   ...
   save(onco_result,file=paste0("/data/zhangh20/breast_cancer/standard_gwas/case_control/onco/onco_result_odds_sd.Rdata"))
