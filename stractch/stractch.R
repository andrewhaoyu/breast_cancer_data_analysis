...
if(i1<=180){
  ...
  Heter.result.G.Icog = EMmvpoly(y.pheno.mis1,baselineonly = x.all.mis1[,1,drop=F],additive = x.all.mis1[,3:6] ,pairwise.interaction = x.all.mis1[,7:8],saturated =NULL,missingTumorIndicator = 888)
