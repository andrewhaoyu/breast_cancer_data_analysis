...
load(paste0("/data/zhangh24/breast_cancer_data_analysis/whole_genome_age/ICOG/Intrinsic_subtypes/result/intrinsic_subtype_triple_negative_results.Rdata"))
log.odds <- rep(0,4121)
var.log.odds <- rep(0,4121)
total <- 0
for(i1 in 1:825){
  print(i1)
  load(paste0("/data/zhangh24/breast_cancer_data_analysis/discovery_SNP/CIMBA_conditional_analysis/result/conditional_result",i1,".Rdata"))
...
save(intrinsic_subtype_triple_negative_results_chr12,
     file = "/data/zhangh24/breast_cancer_data_analysis/discovery_SNP/CIMBA_conditional_analysis/result/intrinsic_subtype_triple_negative_results_chr12.Rdata")
