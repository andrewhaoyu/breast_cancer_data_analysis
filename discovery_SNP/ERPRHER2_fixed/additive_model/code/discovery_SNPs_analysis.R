...
if(i1<=9){
  ...
  load("/spin1/users/zhangh24/breast_cancer_data_analysis/whole_genome/ICOG/ERPRHER2_fixed/result/topsnpvalue.Rdata")
  ...
  x.test.all.mis1 <- extract.result.icog.top
  ...
  colnames(y.pheno.mis2) = c("Behaviour","ER",
                             "PR","HER2")
  load("/spin1/users/zhangh24/breast_cancer_data_analysis/whole_genome/ONCO/ERPRHER2_fixed/result/topsnpvalue.Rdata")  
  x.test.all.mis2 <- extract.result.onco.top
