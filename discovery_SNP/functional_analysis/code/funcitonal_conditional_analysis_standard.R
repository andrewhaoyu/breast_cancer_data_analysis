...
load("./discovery_SNP/functional_analysis/result/ICOG/functional_conditional_icog_snpvalue_standard.Rdata")
load("./discovery_SNP/functional_analysis/result/ONCO/functional_conditional_onco_snpvalue_standard.Rdata")
...
save(p.value.result,
     file = paste0("./discovery_SNP/functional_analysis/result/ICOG/p.value.result_standard",i1,".Rdata"))
