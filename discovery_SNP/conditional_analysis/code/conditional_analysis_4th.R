...
for(i2 in 1:(end-start+1)){
  ...
  if(known.flag%in%known.flag.3rd){
    known.flag.new<- known.flag
    if(known.flag.new!=known.flag.last){
      
      
      load(paste0("/data/zhangh24/breast_cancer_data_analysis/discovery_SNP/conditional_analysis/result/score.test.support.icog.4th",known.flag,".Rdata"))
      load(paste0("/data/zhangh24/breast_cancer_data_analysis/discovery_SNP/conditional_analysis/result/score.test.support.onco.4th",known.flag,".Rdata"))
...
save(p.value.all,file=paste0("/data/zhangh24/breast_cancer_data_analysis/discovery_SNP/conditional_analysis/result/psub.4th",i1,".Rdata"))
