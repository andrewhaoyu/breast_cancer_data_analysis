...
if(i1 %in%first.known.flag){
  if(i1 ==178|i1==207|i1==172|i1==122){
    ...
    x.all.mis2 <- cbind(snp.onco,known.snp.value.onco,
                        first.snp.value.onco,x.covar.mis2)
    ...
    save(score.test.support.icog,file=paste0("/data/zhangh24/breast_cancer_data_analysis/discovery_SNP/conditional_analysis/result/score.test.support.icog.2nd",i1,".Rdata"))
    save(score.test.support.onco,file=paste0("/data/zhangh24/breast_cancer_data_analysis/discovery_SNP/conditional_analysis/result/score.test.support.onco.2nd",i1,".Rdata"))
