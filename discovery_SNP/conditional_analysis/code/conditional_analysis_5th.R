...
for(i2 in 1:(end-start+1)){
  ...
  if(known.flag%in%known.flag.4th){
    known.flag.new<- known.flag
    if(known.flag.new!=known.flag.last){
      
      
      load(paste0("/data/zhangh24/breast_cancer_data_analysis/discovery_SNP/conditional_analysis/result/score.test.support.icog.5th",known.flag,".Rdata"))
      load(paste0("/data/zhangh24/breast_cancer_data_analysis/discovery_SNP/conditional_analysis/result/score.test.support.onco.5th",known.flag,".Rdata"))
    ...
    conditional.snps.icog <- cbind(conditional.snps.icog.first,conditional.snps.icog.2nd,conditional.snps.icog.3rd,conditional.snps.icog.4th)
...
save(p.value.all,file=paste0("/data/zhangh24/breast_cancer_data_analysis/discovery_SNP/conditional_analysis/result/psub.5th",i1,".Rdata"))
