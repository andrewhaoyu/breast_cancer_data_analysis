...
if(i1 %in%known.flag.4th){
  if(i1 ==178|i1==207|i1==172|i1==122){
    ...
    x.all.mis2 <- cbind(snp.onco,known.snp.value.onco,
                        first.snp.value.onco,snp.value.onco.2nd,snp.value.onco.3rd,snp.value.onco.4th,x.covar.mis2)
    ...
    save(score.test.support.icog,file=paste0("/data/zhangh24/breast_cancer_data_analysis/discovery_SNP/conditional_analysis/result/score.test.support.icog.5th",i1,".Rdata"))
    save(score.test.support.onco,file=paste0("/data/zhangh24/breast_cancer_data_analysis/discovery_SNP/conditional_analysis/result/score.test.support.onco.5th",i1,".Rdata"))
