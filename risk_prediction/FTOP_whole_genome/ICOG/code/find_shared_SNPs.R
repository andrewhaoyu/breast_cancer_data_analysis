load("/data/zhangh24/breast_cancer_data_analysis/risk_prediction/FTOP_whole_genome/ICOG/result/Icog_result.Rdata")
load("/data/zhangh24/breast_cancer_data_analysis/risk_prediction/FTOP_whole_genome/ONCO/result/onco_result.Rdata")
