...
save(icog_result_shared,file="./risk_prediction/intrinsic_subtypes_whole_genome/ICOG/result/icog_result_shared.Rdata")
save(onco_result_shared,file="./risk_prediction/intrinsic_subtypes_whole_genome/ONCO/result/onco_result_shared.Rdata")
...
save(icog_result_shared_1p,file="./risk_prediction/intrinsic_subtypes_whole_genome/ICOG/result/icog_result_shared_1p.Rdata")
save(onco_result_shared_1p,file="./risk_prediction/intrinsic_subtypes_whole_genome/ONCO/result/onco_result_shared_1p.Rdata")
...
save(icog_result_only_shared_1p,file="./risk_prediction/intrinsic_subtypes_whole_genome/ICOG/result/icog_result_only_shared_1p.Rdata")
save(onco_result_only_shared_1p,file="./risk_prediction/intrinsic_subtypes_whole_genome/ONCO/result/onco_result_only_shared_1p.Rdata")
