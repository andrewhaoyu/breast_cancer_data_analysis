...
load("./risk_prediction/intrinsic_subtypes_whole_genome/ICOG/result/icog_result_only_shared_1p.Rdata")
load("./risk_prediction/intrinsic_subtypes_whole_genome/ONCO/result/onco_result_only_shared_1p.Rdata")
...
save(result_summary,file=paste0("./risk_prediction/intrinsic_subtypes_whole_genome/ICOG/result/reuslt_summary_sub",i1,".Rdata"))
