...
for(i in 1:567){
  ...
  print(i)  
  geno.file <- paste0("/data/zhangh24/breast_cancer_data_analysis/risk_prediction/Nasim_prs/result/extracted_snp_onco_313_",i,".txt")
...
save(onco.nasim.snp, file = "/data/zhangh24/breast_cancer_data_analysis/risk_prediction/Nasim_prs/result/onco.nasim.snp.rdata")
