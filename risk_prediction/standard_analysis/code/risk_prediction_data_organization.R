...
write.csv(newdata1,file="/data/zhangh24/breast_cancer_data_analysis/data/sig_snps_icog.csv",row.names=F,quote = F)
write.csv(newdata2,file="/data/zhangh24/breast_cancer_data_analysis/data/sig_snps_onco.csv",
          row.names=F,quote = F)
