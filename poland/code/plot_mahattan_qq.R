...
gwas_result3 <- data.frame(SNP=as.character(onco_result_casecase_5p$rs_id),CHR=onco_result_casecase_5p$CHR,BP=onco_result_casecase_5p$position,
                           P=onco_result_standard_5p$p_values1,stringsAsFactors =F)
...
gwas_result4 <- data.frame(SNP=as.character(onco_result_casecase_5p$rs_id),CHR=onco_result_casecase_5p$CHR,BP=onco_result_casecase_5p$position,
                           P=onco_result_standard_5p$p_values2,stringsAsFactors =F)
