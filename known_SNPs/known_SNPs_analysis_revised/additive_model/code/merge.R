...
setwd("/spin1/users/zhangh24/breast_cancer_data_analysis/known_SNPs/known_SNPs_analysis_revised/additive_model/result")
library(xlsx)
...
write.xlsx(first.stage,file="./additive_model.xlsx",sheetName="
           additive_1st_stage",append=T)
