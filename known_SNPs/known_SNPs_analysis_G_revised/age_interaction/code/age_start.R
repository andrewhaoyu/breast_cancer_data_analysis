...
if(i1<=177){
  ...
  age.complete <- age[idx.complete]
  snp <- x.test.all.mis1[idx.complete,i1]
  age.cat <- ifelse(age.complete>50,1,0)
  idx.high <- which(age.cat==1)
  #age.snp.inter <- age.cat*snp
  
  x.all.mis1 <- as.matrix(cbind(snp,age.complete,x.covar.mis1))
  x.all.mis1 <- x.all.mis1[idx.high,]
  y.pheno.mis1 <- y.pheno.mis1[idx.high,]
  #x.all.mis1 <- as.matrix(cbind(snp,age.complete,x.covar.mis1))
  ...
  log.odds.icog.2 <- Heter.result.Icog[[1]][(1+number.of.tumor)+((M+1):(M+1+number.of.tumor))]
  
  sigma.log.odds.icog.2 <- Heter.result.Icog[[2]][(1+number.of.tumor)+((M+1):(M+1+number.of.tumor)),(1+number.of.tumor)+((M+1):(M+1+number.of.tumor))]
  ...
  age.complete <- age[idx.complete]
  snp <- x.test.all.mis2[idx.complete,i1]
  age.cat <- ifelse(age.complete>50,1,0)
  age.snp.inter <- age.cat*snp
  ...
  x.all.mis2 <- as.matrix(cbind(snp,age.complete,x.covar.mis2))
  
  idx.high <- which(age.cat==1)
  x.all.mis2 <- x.all.mis2[idx.high,]
  y.pheno.mis2 <- y.pheno.mis2[idx.high,]
  #x.all.mis2 <- as.matrix(cbind(snp,age.complete,x.covar.mis2))
  ...
  log.odds.onco.2 <- Heter.result.Onco[[1]][(1+number.of.tumor)+((M+1):(M+1+number.of.tumor))]
  
  sigma.log.odds.onco.2 <- Heter.result.Onco[[2]][(1+number.of.tumor)+((M+1):(M+1+number.of.tumor)),(1+number.of.tumor)+((M+1):(M+1+number.of.tumor))]
  ...
  age.complete <- age[idx.complete]
  snp <- x.test.all.mis2[idx.complete,idxi1]
  age.cat <- ifelse(age.complete>50,1,0)
  age.snp.inter <- age.cat*snp
  y.pheno.mis2 <- y.pheno.mis2[idx.complete,]
  x.covar.mis2 <- x.covar.mis2[idx.complete,]
  ...
  x.all.mis2 <- as.matrix(cbind(age.snp.inter,snp,age.complete,x.covar.mis2))
  #x.all.mis2 <- as.matrix(cbind(snp,age.complete,x.covar.mis2))
  
  
  
  # x.all.mis2 <- as.matrix(cbind(x.test.all.mis2[,i1],x.covar.mis2))
  colnames(x.all.mis2)[1] = "age.gene.inter"
  ...
  second.stage.logodds.meta.2 <-log.odds.onco.2
  second.stage.sigma.meta.2 <- sigma.log.odds.onco.2
