...
colnames(first.stage) <- generate_second_stage_parameter_names(tumor.characteristics)
...
write.xlsx(result,file="./age_interaction.xlsx",sheetName="snp.age.interaction")
write.xlsx(first.stage,file="./age_interaction.xlsx",sheetName="snp",append=T)
