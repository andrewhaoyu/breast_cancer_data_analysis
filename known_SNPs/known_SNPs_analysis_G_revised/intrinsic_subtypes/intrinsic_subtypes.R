...
if(i1<=180){
  ##analysis for Icog
  data1 <- as.data.frame(read_csv("./data/iCOGS_euro_v10_05242017.csv"))
  ...
  Heter.result.G.Icog = EMmvpoly(y.pheno.mis1,baselineonly = NULL,main.effect = x.all.mis1,pairwise.interaction = NULL,saturated = NULL,missingTumorIndicator = 888)
  ...
  data2 <- as.data.frame(read_csv("./data/Onco_euro_v10_05242017.csv"))
  ...
  Heter.result.G.Onco = EMmvpoly(y.pheno.mis2,baselineonly = NULL,main.effect = x.all.mis2,pairwise.interaction = NULL,saturated = NULL,missingTumorIndicator = 888)
  ...
  data2 <- as.data.frame(read_csv("./data/Onco_euro_v10_rs554219.csv"))
